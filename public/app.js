var AppProcess = (function () {
  ...
  async function videoProcess(newVideoState) {
    ...
    try {
      ...
      console.error("Error starting video source:", e);
      return;
    }
...
var MyApp = (function () {
  ...
  function event_process_for_signaling_server() {
    ...
    socket.on("showFileMessage", function (data) {
      ...
      attachFileAreaForOther.innerHTML +=
        "<div class='left-align' style='display:flex; align-items:center;'>/images/other.jpg' style='height:40px;width:40px;' class='caller-image circle'><div style='font-weight:600;margin:0 5px;'>" +
        data.username +
  ...
  $(document).on("click", ".end-call-wrap", function () {
    $(".top-box-show")
      ...
      .html(
        '<div class="top-box align-vertical-middle profile-dialogue-show"> <h4 class="mt-3" style="text-align:center;color:white;">Leave Meeting</h4> <hr> <div class="call-leave-cancel-action d-flex justify-content-center align-items-center w-100"> <a href="/action"><button class="call-leave-action btn btn-danger mr-5">Leave</button></a> <button class="call-cancel-action btn btn-secondary">Cancel</button> </div> </div>'
      );
  });
  ...
  $(document).on("click", ".share-attach", function (e) {
    ...
    var attachFilePath =
      "public/" + meeting_id + "/" + attachFileName;
